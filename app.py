...
if st.session_state["df_results"] is None:
    ...
    for _, row in merged.iterrows():
        ...
        results.append({
            ...
            "kgvpMarketplace": row.get("kgvpMarketplace", 0),
            "paidStorageKgvp": row.get("paidStorageKgvp", 0),
            "kgvpSupplier": row.get("kgvpSupplier", 0),
            "kgvpSupplierExpress": row.get("kgvpSupplierExpress", 0),
